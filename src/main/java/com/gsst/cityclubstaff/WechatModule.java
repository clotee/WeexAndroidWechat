...
//                miniProgramObj.webpageUrl = params.getString("webpageUrl"); // 兼容低版本的网页链接
                miniProgramObj.webpageUrl = "http://www.qq.com"; // 兼容低版本的网页链接
                int miniprogramType = params.getInteger("miniProgramType");
                if(miniprogramType - 1 == 0) {
                    miniProgramObj.miniprogramType = WXMiniProgramObject.MINIPTOGRAM_TYPE_RELEASE;
                }
                if(miniprogramType - 2 == 0) {
                    miniProgramObj.miniprogramType = WXMiniProgramObject.MINIPROGRAM_TYPE_TEST;
                }
                if(miniprogramType - 3 == 0) {
                    miniProgramObj.miniprogramType = WXMiniProgramObject.MINIPROGRAM_TYPE_PREVIEW;
                }
//                miniProgramObj.miniprogramType = WXMiniProgramObject.MINIPTOGRAM_TYPE_RELEASE;// 正式版:0，测试版:1，体验版:2
                miniProgramObj.userName = params.getString("userName");     // 小程序原始id
                miniProgramObj.path = params.getString("path");            //小程序页面路径
